# Ethiopia Law MCP Server — Developer Guide
...
Ethiopia Law MCP server providing Ethiopian legislation search via Model Context Protocol. Strategy A deployment (Vercel, bundled SQLite DB). Covers data protection, cybercrimes, ICT, companies, consumer protection, and other key Acts.
...
- Ethiopia uses "Section N" for Acts and "Article N" for the Constitution
...
1. `scripts/ingest.ts` -> fetches from Ethiopia Law -> JSON seed files in `data/seed/`
...
- **Ethiopia Law** (ethiopialaw.org) -- National Council for Law Reporting
- **License:** Government Open Data
- **Languages:** English (en) is the primary legal language; Swahili (sw) for some documents
- **Coverage:** All Acts of Parliament, subsidiary legislation, Constitution of Ethiopia 2010, selected case law

## Ethiopia-Specific Notes

- Ethiopia uses a common law legal system inherited from British colonial administration
- The Constitution of Ethiopia 2010 is the supreme law (Article 2)
...
- For the Constitution: "Article N, Constitution of Ethiopia 2010"
...
- npm package: `@ansvar/ethiopia-law-mcp` with bin entry for stdio
