...
**Endpoint:** `https://mcp.ansvar.eu/law-et/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add ethiopian-law --transport http https://mcp.ansvar.eu/law-et/mcp` |
...
```json
{
  "mcpServers": {
    "ethiopian-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-et/mcp"
    }
  }
}
```
