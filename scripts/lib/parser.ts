/**
 * Ethiopia Law PDF Parser
 *
 * Parses text extracted from Ethiopian proclamation PDFs (Federal Negarit Gazette).
...
export function parseEthiopiaLawHtml(html: string, act: ActIndexEntry): ParsedAct {
  return parsePdfText(html, act);
}
