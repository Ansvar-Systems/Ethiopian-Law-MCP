#!/usr/bin/env tsx
/**
 * Ethiopia Law MCP -- Census Script
 *
 * Enumerates ALL proclamations, regulations, and directives from lawethiopia.com.
...
const BASE_URL = 'https://www.lawethiopia.com';
...
const FEDERAL_CATEGORIES = [
  ...
  'banking-and-monetary-system/national-bank-of-ethiopia',
  ...
  'parliament', 'police', 'president-of-ethiopia', 'prison',
...
async function scrapeCategoryPage(categoryPath: string): Promise<RawLaw[]> {
  ...
  for (const link of links) {
    ...
    if (link.href.startsWith('http') && !link.href.includes('lawethiopia.com')) continue;
...
async function main(): Promise<void> {
  ...
  console.log('Ethiopia Law MCP -- Census Script');
  console.log('=================================\n');
  ...
  console.log(`  Jurisdiction:   Ethiopia (ET)`);
  console.log(`  Source:         ${BASE_URL}`);
