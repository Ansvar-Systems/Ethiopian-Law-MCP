#!/usr/bin/env tsx
/**
 * Ethiopia Law MCP -- Census-Driven Ingestion Pipeline
 *
 * Reads data/census.json and fetches + parses every ingestable Act
 * from lawethiopia.com (Akoma Ntoso HTML).
 *
 * Features:
 ...
 *
 * Data source: lawethiopia.com (National Council for Law Reporting)
...
import { parseEthiopiaLawHtml, type ActIndexEntry, type ParsedAct } from './lib/parser.js';
...
async function main(): Promise<void> {
  ...
  console.log('Ethiopia Law MCP -- Ingestion Pipeline (Census-Driven)');
  console.log('====================================================\n');
  console.log(`  Source: lawethiopia.com (National Council for Law Reporting)`);
  ...
  for (const law of acts) {
    ...
    try {
      ...
      const parsed = parseEthiopiaLawHtml(html, act);
  ...
  console.log(`\n  Source:      lawethiopia.com (Akoma Ntoso HTML)`);
