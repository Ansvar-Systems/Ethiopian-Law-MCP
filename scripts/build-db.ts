#!/usr/bin/env tsx
/**
 * Database builder for Ethiopia Law MCP server.
 *
...
function buildDatabase(): void {
  console.log('Building Ethiopia Law MCP database...\n');
          ...
          if (extractedRefs.length > 0) {
            ...
            for (const ref of extractedRefs) {
              ...
              const euInsert = insertEuDocument.run(
                ...
                shortName, shortName, eurLexUrl, 'Auto-extracted from Ethiopian statute text',
              );
